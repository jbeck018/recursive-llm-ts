...
if [[ $REPLY =~ ^[Yy]$ ]]; then
  ...
  echo "  1. Build and attach Go binaries (linux/amd64, linux/arm64, darwin/amd64, darwin/arm64, windows/amd64)"
  echo "  2. Publish NPM package"
  echo "  3. Generate release checksums"
  echo ""
